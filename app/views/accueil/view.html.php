...
<header class="topbar">
  ...
  <div class="top-right">
    <div class="year-pill"><span class="dot"></span><?php echo $actif['annee'] ?></div>
...
<form action="http://localhost:8002/showMoyenne" method="POST">
  <div class="filters-card" id="filtersCard">
    <div class="field">
      <label for="classe">Classe</label>
      <div class="select-wrap">
        <select id="classe" name="idClasse">
    ...
    <div class="field">
      ...
      <div class="select-wrap">
        <select id="matiere" name="idMatiere">
    ...
    <div class="field">
      ...
      <div class="select-wrap">
        <select id="periode" name="idPeriode">
    ...
    <div class="stat">
      ...
      <div class="stat-value" id="classAvg"><?php echo $moyenne['moyenne'] ? $moyenne['moyenne'] :0 ?><span>/20</span></div>
    </div>
  </div>
</form>
